...
namespace PieceOfCake_API.Migrations
{
    ...
    [Migration("20240418121245_OrderFirstMigrate")]
    partial class OrderFirstMigrate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.AcceptedOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("AcceptingDateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal>("DeliveringCost")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("OverLoadCosts")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.CaptainsCanceledOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CancelingDateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("CaptainsCanceledOrders");
                });

            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.DeliveredOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.InprogressOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InprogressOrders");
                });

            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.MerchantsCanceledOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MerchantsCanceledOrders");
                });

            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.NewOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.RedirectedOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RedirectedOrders");
                });

            modelBuilder.Entity("PieceOfCake_API.Models.Orders.OrderCancellationReasons", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.Orders.OrdersComplaints", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.AcceptedOrders", b =>
                {
                    ...
                    b.HasOne("PieceOfCake_API.Models.Customers", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieceOfCake_API.Models.Stores", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("PieceOfCake_API.Models.NewFolder.CaptainsCanceledOrders", b =>
                {
                    ...
                    b.HasOne("PieceOfCake_API.Models.Orders.OrderCancellationReasons", "Reason")
                        .WithMany()
